...
#        1.) Start range of *. 
#        2.) End range of *.
#        3.) Character string of path to the directory that contains imputed_snps_chr_*.RData as generated by get_imputed_snps.R
#        4.) Character string to path where the MGS_DO_* directories are stored ( contains the fastq and .bam/.bai files)
#
#
#
#    Output:
