...
### Within each of the sample's directory, create a directory for week 6, 17, and 24.
#     Then within each of the week's directory, create a Pair_End and Singleton directory. 
#     Finally move files to their appropriate directory.
for(i in dir()){
