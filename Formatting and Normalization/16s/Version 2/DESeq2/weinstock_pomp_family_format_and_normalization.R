...
### Keep family with counts in more than 5% of samples
family_w6_count  <- family_w6_count[,colSums(family_w6_count > 0) > (nrow(family_w6_count) * .05)]
family_w17_count <- family_w17_count[,colSums(family_w17_count > 0) > (nrow(family_w17_count) * .05)]
family_w24_count <- family_w24_count[,colSums(family_w24_count > 0) > (nrow(family_w24_count) * .05)]
