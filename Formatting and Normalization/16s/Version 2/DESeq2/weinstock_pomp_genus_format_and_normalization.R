...
### Keep genus with counts in more than 5% of samples
genus_w6_count  <- genus_w6_count[,colSums(genus_w6_count > 0) > (nrow(genus_w6_count) * .05)]
genus_w17_count <- genus_w17_count[,colSums(genus_w17_count > 0) > (nrow(genus_w17_count) * .05)]
genus_w24_count <- genus_w24_count[,colSums(genus_w24_count > 0) > (nrow(genus_w24_count) * .05)]
